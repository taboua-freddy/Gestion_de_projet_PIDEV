...
abstract class Activite {
    ...
    protected LocalDateTime dateRappel;

    public Activite() {
    }

    public Activite(int id, String titre, LocalDateTime dateDebut, LocalDateTime dateFin, String description,LocalDateTime dateRappel) {
        this.id = id;
        this.titre = titre;
    ...
    public Activite(String titre, LocalDateTime dateDebut, LocalDateTime dateFin, String description,LocalDateTime dateRappel) {
        this.titre = titre;
        this.dateDebut = dateDebut;
        this.dateFin = dateFin;
        this.description = description;
